# sm-api-developer-portal（API 开发者门户）运维手册

## 1. 服务概述与依赖

sm-api-developer-portal 为 SM 平台API 开发者门户，监听容器端口 8011。
...
1. `helm history sm-api-developer-portal` 查看版本。
2. `helm rollback sm-api-developer-portal <上一版本>`。
...
- 日志排查：`kubectl logs -l app.kubernetes.io/instance=sm-api-developer-portal` 或 Loki 按 job=sm-api-developer-portal 检索。
