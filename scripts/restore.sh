#!/bin/bash
# =============================================================================
# 恢复脚本 - sm-api-developer-portal
# -----------------------------------------------------------------------------
# 功能：从指定的 .sql.gz 备份文件恢复 PostgreSQL 数据库
#
# 使用：
#   chmod +x scripts/restore.sh
#   ./scripts/restore.sh /backup/sm-api-developer-portal/20260916_020000.sql.gz
#   ./scripts/restore.sh -f /backup/sm-api-developer-portal/20260916_020000.sql.gz   # 非交互，跳过确认
#
# 环境变量：
...
SERVICE_NAME="sm-api-developer-portal"
DB_HOST="${DB_HOST:-postgres}"
DB_PORT="${DB_PORT:-5432}"
DB_NAME="${DB_NAME:-sm_api_developer_portal_db}"
